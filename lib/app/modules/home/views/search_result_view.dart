...
onTap: (latLng){
  controller.getGeocodingOfLatLng(latLng.latitude,latLng.longitude);
              ...
              Padding(
                ...
                child: Row(
                  ...
                  PrimaryText("الموقع",fontSize: 14.sp,fontWeight: FontWeight.w400,color: const Color(0xFF525A64),),
                     PrimaryText("${controller.street}/${controller.country}",fontSize: 12.sp,fontWeight: FontWeight.w400,color: const Color(0xFF525A64),),
                  ],),
                    SizedBox(width: 20.w,),
      ...
      bottomNavigationBar: PrimaryBottomSheet(
        Get.width, 80.h, 25.r, "حفظ", 0xFFD84E67, 0xFFFFFFFF, 0x0a000000,function: (){
          Get.toNamed("/home",arguments: controller.myMarker,);
      },),
    );
  }
}
