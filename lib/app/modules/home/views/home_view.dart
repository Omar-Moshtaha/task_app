...
class HomeView extends GetView<HomeController> {
  ...
  marker=Get.arguments??[MyMarker({const Marker(markerId: MarkerId("1"),position: LatLng(0,0))},"","")];
    return Scaffold(
              ...
              builder: (context){
                return Column(
                    ...
                    children: [
                      ...
                      controller.step[1].value==true?Visibility(
...
controller.changeValueOfDrowdwonButtom(value);
                                  }),
                                ),
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.end,children: [
                                  PrimaryImage("assets/images/mins_with_background.png",funtion: (){
                                  ...
                                  Container(width: 70.w,height: 40.h,decoration: BoxDecoration(
                                      ...
                                      color: const Color(0xFFFAFAFA),
                                      border: Border.all(color: const Color(0xFFEEF1F5))
                                  ),child: Center(child: PrimaryText("${controller.count.value}",color: const Color(0xFF757A86),fontSize: 14.sp,fontWeight: FontWeight.w400,)),),
                                  SizedBox(width: 10.w,),
                                  PrimaryImage("assets/images/add_with_background.png",funtion: (){
                                ...
                                Row(
                                  ...
                                  children: [
                                    Center(child:
                                    SizedBox(width: 70,child: PrimaryTextField( hintText: '0', controller: controller.numberOfSeats, validator: (String? value) {
                                      return null;
                                      },))),
                                    SizedBox(width: 20.w,),
                                    Padding(
                                      padding:  EdgeInsets.only(top: 8.h),
                                      child: PrimaryText("عدد المقاعد/يتسع لـ",color: const Color(0xFF335C87),fontWeight: FontWeight.w700,fontSize: 12.sp,textAlign: TextAlign.right,),
                                    ),
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.end,children: [
                                  PrimaryImage("assets/images/mins_with_background.png",funtion: (){
                                    controller.decreaseTheNumberOfRooms();
                                  },),
                                  ...
                                  Container(width: 70.w,height: 40.h,decoration: BoxDecoration(
                                      ...
                                      color: const Color(0xFFFAFAFA),
                                      border: Border.all(color: const Color(0xFFEEF1F5))
                                  ),child: Center(child: PrimaryText("${controller.numberOfRooms.value}",color: const Color(0xFF757A86),fontSize: 14.sp,fontWeight: FontWeight.w400,)),),
                                  SizedBox(width: 10.w,),
                                  PrimaryImage("assets/images/add_with_background.png",funtion: (){
                                    controller.increaseTheNumberOfRooms();
                                ...
                                SizedBox(height: 10.h,),
ListView.separated(shrinkWrap: true,physics: const NeverScrollableScrollPhysics(),itemBuilder: (context,index)=>
                Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                Row(
                ...
                },child: const PrimaryText("حذف الغرفة",color: Color(0xFFD84E67),fontSize: 10,fontWeight: FontWeight.w700,)),
                const Spacer(),

                PrimaryText("${controller.dataOfRoom[index]['NumberOfRooms']}غرفة رقم ",color: const Color(0xFFD84E67),fontSize: 10,fontWeight: FontWeight.w700,),
                ...
                SizedBox(height: 10.w,),
                  ...
                  Row(
                    ...
                    children: [
                        Center(child:
                        SizedBox(width: 60.w,height: 60.h,child: PrimaryTextField(hintText: '0', validator: (String? value) {
                          return null;
                          }, controller: controller.dataOfRoom[index]['Number_of_double_beds'],))),
                        SizedBox(width: 10.w,),
                        Padding(
                          padding:  EdgeInsets.only(top: 8.h),
                          child: SizedBox(width: 100.w,child: PrimaryText("عدد الأسرة المزدوجة",color: const Color(0xFF335C87),fontWeight: FontWeight.w700,fontSize: 12.sp,textAlign: TextAlign.right,)),
                        ),
                  ...
                  Row(
                    ...
                    children: [
                        ...
                        SizedBox(width: 60.w,height: 60.h,child: PrimaryTextField(hintText: '0', validator: (String? value) {
                          return null;
                          }, controller:  controller.dataOfRoom[index]['number_of_single_beds'],))),
                        SizedBox(width: 10.w,),
                        Padding(
                          padding:  EdgeInsets.only(top: 8.h),
                          child: SizedBox(width: 100.w,child: PrimaryText("عدد الأسرة الفردية",color: const Color(0xFF335C87),fontWeight: FontWeight.w700,fontSize: 12.sp,textAlign: TextAlign.right,)),
                        ),
                  ...
                  Row(
                    ...
                    children: [
                        ...
                        SizedBox(width: 60.w,height: 60.h,child: PrimaryTextField(hintText: '0', validator: (String? value) {
                          return null;
                          }, controller: controller.dataOfRoom[index]['number_of_sofa_beds'],))),
                        SizedBox(width: 10.w,),
                        Padding(
                          padding:  EdgeInsets.only(top: 8.h),
                          child: SizedBox(width: 100.w,child: PrimaryText("عدد أسرة الأريكة",color: const Color(0xFF335C87),fontWeight: FontWeight.w700,fontSize: 12.sp,textAlign: TextAlign.right,)),
                        ),
                ...
                controller.changeValueOfIndex(index);
                 ...
                 separatorBuilder: (context,index)=>SizedBox(height: 20.h,), itemCount: controller.numberOfRooms.value),
                                SizedBox(height: 10.h,),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.end,
                                  children: [
                                    ...
                                    Row(children: [
                                      Expanded(
                                        child: GestureDetector(
                                          onTap: (){
                                            controller.changeValueOfMyThreeChoose();
                                          },
                                          child: Container(
                                            height: 35.h,
                                            decoration: BoxDecoration(
                                              color: const Color(0xFFFFFFFF),
                                              border: Border.all(color:controller.myThreeChoose==true ?const Color(0XffD84E67):Colors.white),
                                      ...
                                      Expanded(
                                        child: GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: const Color(0xFFFFFFFF),
                                              border: Border.all(color:controller.myThreeChoose==false ?const Color(0XffD84E67):Colors.white),
                                    ...
                                    Row(children: [
                                      Expanded(
                                        child: GestureDetector(
                                          onTap: (){
                                            controller.changeValueOfMyFourChoose();
                                          },
                                          child: Container(
                                            height: 35.h,
                                            decoration: BoxDecoration(
                                              color: const Color(0xFFFFFFFF),
                                              border: Border.all(color:controller.myFourChoose==true ?const Color(0XffD84E67):Colors.white),
                                      ...
                                      Expanded(
                                        child: GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: const Color(0xFFFFFFFF),
                                              border: Border.all(color:controller.myFourChoose==false ?const Color(0XffD84E67):Colors.white),
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                            PrimaryText("موقع العقار",fontSize: 16.sp,fontWeight: FontWeight.w700,color: const Color(0xFFD84E67),),
                            const PrimaryDivider(0xFFC7C7C7),
                            PrimaryText("يرجى تحديد موقع العقار على الخريطة",fontSize: 16.sp,fontWeight: FontWeight.w700,color: const Color(0xFF707070),),
                            SizedBox(height: 10.h,),
                ...
                decoration: BoxDecoration(
                            ...
                            ),width: Get.width,height:  200.h,child:  Stack(
                              children: [
                                GoogleMap(
...
markers:marker?[0].marker??{},
                                ...
                                GestureDetector(onTap: (){
                                  Get.offAllNamed("/SearchResultPage");

                                },child: Container(width: Get.width,height: 200,color: Colors.white.withOpacity(0),)),
                              ],
                            ),),
                            SizedBox(height: 10.h,),

                            PrimaryText("الموقع الذي تم إختياره",fontSize: 14.sp,fontWeight: FontWeight.w700,color: const Color(0xFF335C87),),
                            SizedBox(height: 10.h,),

                            PrimaryText("${marker?[0].street}/${marker?[0].country}",fontSize: 14.sp,fontWeight: FontWeight.w700,color: const Color(0xFF525A64),),
                            const PrimaryDivider(0xFFC7C7C7),
                            Row(mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                ...
                                PrimaryText("إظهار الموقع الدقيق قبل الحجز",fontSize: 14.sp,fontWeight: FontWeight.w700,color: const Color(0xFF333333),),
                              ],
                            ),
                            SizedBox(height: 10.h,),

                            PrimaryText("يمكنك إختيار إظهار موقعك الدقيق على الخريطة للضيوف المحتملين \nحتى قبل الحجز في حال كان عقارك للإستخدام التجاري ولا يوجد لديك\n أي تحفظ على إظهار موقعك الدقيق. إذا لم ترغب بهذا الخيار سيتم\n إظهار الموقع التقريبي لعقارك للضيوف المحتملين على أن يتم إظهار\n الموقع الدقيق بعد تأكيد الحجز",fontSize: 12.sp,fontWeight: FontWeight.w400,color: const Color(0xFF707070),),
           ...
           controller.step[0].value==true?    GetBuilder<HomeController>(
             builder: (context){
          return  Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                PrimaryText("الاسعار",fontSize: 16.sp,fontWeight: FontWeight.w700,color: const Color(0xFFD84E67),),
                const Divider(color: Color(0xfffc7c7c7),),
                PrimaryText("إختر أيام وسط الأسبوع",fontSize: 14.sp,fontWeight: FontWeight.w700,color: const Color(0xFF335C87),),
                SizedBox(height: 10.h,),
                SizedBox(height: 30.h,
                  child:   ListView.separated(scrollDirection: Axis.horizontal,shrinkWrap: true,itemBuilder: (context,index)=>GestureDetector(
                    onTap: (){
                      controller.addToListDays(index);
                    },
                    child: Container(
                      width: 50.w,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20.r),
                          color:controller.days.contains(controller.daysOfWeek[index])?const Color(0xFFF3C8D0): const Color(0xFFFFFFFF),
                ...
                PrimaryText("سعر أيام وسط الأسبوع",fontSize: 14.sp,fontWeight: FontWeight.w700,color: const Color(0xFF335C87),),
                SizedBox(height: 10.h,),
                ...
                PrimaryText("إختر أيام نهاية الأسبوع",fontSize: 14.sp,fontWeight: FontWeight.w700,color: const Color(0xFF335C87),),
                SizedBox(height: 10.h,),
...
controller.addToListweekend(index);
                    },
                    child: Container(
                      width: 50.w,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20.r),
                          color:controller.weekend.contains(controller.daysOfWeek[index])?const Color(0xFFF3C8D0): const Color(0xFFFFFFFF),
                ...
                PrimaryText("أسعار نهاية الأسبوع",fontSize: 14.sp,fontWeight: FontWeight.w700,color: const Color(0xFF335C87),),
                Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.end,
                      children: [
                        Container(width: 70.w,height: 40.h,decoration: BoxDecoration(
                            ...
                            color: const Color(0xFFFAFAFA),
                            border: Border.all(color: const Color(0xFFEEF1F5))
                        ),child: Center(child: PrimaryText("120",color: const Color(0xFF757A86),fontSize: 14.sp,fontWeight: FontWeight.w400,)),),
                        SizedBox(width: 30.w,),
                        SizedBox(width: 100.w,child: PrimaryText("الخميس",color: const Color(0xFF335C87),fontWeight: FontWeight.w700,fontSize: 12.sp,textAlign: TextAlign.right,)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 30.w,),
                        SizedBox(width: 100.w,child: PrimaryText("الجمعة",color: const Color(0xFF335C87),fontWeight: FontWeight.w700,fontSize: 12.sp,textAlign: TextAlign.right,)),
